...
public class CallGraphTestUtil
{
	...
	{
		AnalysisScope scope =
		        AnalysisScopeReader.readJavaScope(scopeFile, (new FileProvider()).getFile(exclusionsFile),
		                MY_CLASSLOADER);
		return scope;
	}

	public static CallGraph buildRTA(AnalysisOptions options, AnalysisCache cache, IClassHierarchy cha,
	...
	public static CallGraph buildZeroCFA(AnalysisOptions options, AnalysisCache cache, IClassHierarchy cha,
	        AnalysisScope scope, boolean testPAtoString) throws IllegalArgumentException, CancelException
	{
		StopwatchGC S = null;
		if (CHECK_FOOTPRINT)
		{
	...
	public static CallGraph buildZeroOneCFA(AnalysisOptions options, AnalysisCache cache, IClassHierarchy cha,
	        AnalysisScope scope, boolean testPAtoString) throws IllegalArgumentException, CancelException
	{
		StopwatchGC S = null;
		if (CHECK_FOOTPRINT)
